      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-gold mb-8 font-sans text-xs tracking-widest uppercase">Boîtier à clés & Autonomie</p>
          ...
          >
            ...
            <p className="text-gold/80 mb-8 font-sans text-xs tracking-widest uppercase">Accueil Physique & Premium</p>
